...
<div class="container-fluid">
            ...
            <div class="text-warning p-2s d-flex justify-content-md-end">
                ...
                <div class="dropdown m-2">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                        <li><a class="dropdown-item" href="{{url('/admin/profile/1')}}"><i class="fa-solid fa-user"></i> profile</a></li>
    ...
    <div class="row">
        ...
        <nav class="navbar navbar-light navbar-expand-lg mynavbar position-lg-fixed">
            <div class="container-fluid">
                {{-- <a class="navbar-brand" href="#"><i class="bi bi-house-fill"></i> Admin Dashboard</a> --}}
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="{{url('/admin/payment')}}"><i class="bi bi-cart-plus-fill"></i> Order Confirmation</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                        <a href="{{url('/admin/jobs')}}"><i class="bi bi-briefcase-fill"></i> Jobs Management</a>
                        </li>
                        <li class="nav-item">
                        <a href="{{url('/admin/payment-methods')}}"><i class="bi bi-credit-card-2-front-fill"></i> Payment Account Management</a>
                        </li> 
                        <li class="nav-item">
