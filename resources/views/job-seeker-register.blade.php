<form action="{{ route('register.jobseeker') }}" method="post" class="bg-white px-3 pb-2 rounded shadow-lg"
    ...
    <div class="row mb-3">
     ...
     <div class="row mb-3">
        <div class="col-md-3 offset-md-1 col-12">
            <label for="userEmail" class="col-form-label">Email</label></div>
        <div class="col-md-7 col-12">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-7 col-12">
            <input type="date" class="form-control @error('dob') is-invalid @enderror" required placeholder="dob"
    ...
    <div class="row mb-3">
        <div class="col-md-3 offset-md-1 col-12">
            <label for="password" class="col-form-label">Password</label></div>
        <div class="col-md-7 col-12">
            <input type="password" class="form-control @error('password') is-invalid @enderror" required placeholder="Password"
    ...
    <div class="row mb-3">
        <div class="col-md-3 offset-md-1 col-12">
            <label for="password_confirmation" class="col-form-label">Confirm
                password</label></div>
        <div class="col-md-7 col-12">
            <input type="password" class="form-control @error('password.confirmed') is-invalid @enderror" required placeholder="Confirm password"
                name="password_confirmation" id="password_confirmation" value="{{ old('password_confirmation') }}">
                <span class="text-secondary">***one lowercase letter, one uppercase letter, one digit, and one special character</span>
        </div>
    </div> 
    <div class="row mb-3">
        <div class="col-md-3 offset-md-1 col-12">
            <label for="profileImage" class="col-form-label">Profile Image</label></div>
        <div class="col-md-7 col-12">
        <input type="file" class="form-control @error('profileImage') is-invalid @enderror"  name="profileImage" accept=".jpeg,.jpg,.svg,.gif,.png"
