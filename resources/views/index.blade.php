...
@section('content')
    ...
    <section class="">
        <div class="container py-4">
            <h3 class="text-center"><span class="titleFirstPart">Recent</span> <span class="titleSecondPart">Jobs</span> </h3>
            <div class="row g-4 py-2">                 
                <div class="col-lg-3 col-md-4 col-6 col-xs-12">                    
                    <div class="shadow d-flex flex-column justify-content-center align-items-center py-5 job">
                        <img src="images/companies/anandalogo.png" alt="Ananda Digital Myanmar" class="me-2 p-1">
                        <h5>Ananda Co., ltd</h5> 
                        <p class="mb-2 text-center">Senior System Engineer</p>
                        <p class="mb-2 text-center">Yangon</p>
                        <p class="text-secondary mb-4 text-center">Full Time</p>
                        <a href="">
                ...
                <div class="col-lg-3 col-md-4 col-6 col-xs-12">                    
                    <div class="shadow d-flex flex-column justify-content-center align-items-center py-5 job">
                        <img src="images/companies/anandalogo.png" alt="Ananda Digital Myanmar" class="me-2 p-1">
                        <h5>Ananda Co., ltd</h5> 
                        <span class="mb-2">Senior System Engineer</span>
                        <span class="mb-2">Yangon</span>
                        <span class="text-secondary mb-4">Full Time</span>
                        <a href="">
                            <button class="button-18 greenBtn" role="button">view details</button>
                        </a>
                    </div>  
    ...
    <section class="bg-light">
        <div class="container py-4 categories">
            <h3 class="text-center"><span class="titleFirstPart">Popular </span> <span class="titleSecondPart">Categories</span> </h3>
                        ...
                        <div class="category py-2 shadow">                        
                            <div class="d-flex p-2">
                                <div class="circle p-3 bg-white me-2">
                                    <img src="images/categories/saleBusinessDevelopment.png" alt="it/computer">
                                </div>
                                <p class="text-black">Finance, Accounting, Audit<br> <span class="text-secondary">200 jobs</span></p>
                            </div>  
                        </div> 
                    </a>
                </div>
                <div class="col-md-4 col-6 col-xs-12">
                    <div class="category py-2 shadow">
                        <a href="" class="text-decoration-none">
                            <div class="d-flex p-2">
                                <div class="circle p-3 bg-white me-2">
                                    <img src="images/categories/financeAccountingAudit.png" alt="it/computer">
                                </div>
                                <p class="text-black">Sales and Business Development <br> <span>200 jobs</span></p>
                            </div>                        
                        </a>
                    </div>  
                </div>
                    ...
                    <div class="category py-2 shadow">
                        <a href="" class="text-decoration-none">
                            <div class="d-flex p-2">
                                ...
                                <p class="text-black">Finance, Accounting, Audit <br> <span>200 jobs</span></p>
                            </div>                        
                        </a>
                    </div>  
                </div>
        ...
        <div class="container py-4">
            <div class="row py-2 companies">
                <div class="col-md-2 col-6 col-xs-12 text-center">
                    <a href="" >
                        <div class="company">
                        <img src="images/companies/anandalogo.png" alt="Ananda Digital Myanmar" class="img img-fluid">
                        <h6 class="my-2">Ananda Digital</h6>
                        </div>
                    </a>
                </div>
                <div class="col-md-2 col-6 col-xs-12 text-center">
                    <div class="company">
                        <img src="images/companies/unileverlogo.png" alt="Unilever Myanmar" class="img img-fluid">
                        <h6 class="my-2">Unilever</h6>
                    </div>                    
                </div>
                <div class="col-md-2 col-6 col-xs-12 text-center">
                    <div class="company">
                        <img src="images/companies/heinkenlogo.png" alt="oca-Cola Pinya Beverages Myanmar" class="img img-fluid">
                        <h6 class="my-2">Heinken</h6>
                    </div>                    
                </div>
                <div class="col-md-2 col-6 col-xs-12 text-center">
                    <div class="company">
                        <img src="images/companies/agdbanklogo.png" alt="Yoma Bank" class="img img-fluid">
                        <h6 class="my-2">AGD Bank</h6>
                    </div>                    
                </div>
                <div class="col-md-2 col-6 col-xs-12 text-center">
                    <div class="company">
                        <img src="images/companies/grandroyallogo.png" alt="Grand Royal Group International" class="img img-fluid">
                        <h6 class="my-2">Grand Royal Group International</h6>
                    </div>                    
                </div>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-5 p-3">
                    <a href="{{url('/industries')}}"><button class="button-18 myBtn mb-4" role="button">Job industries</button></a>
                    <div class="w-75">
                        <h4>Explore job by most popular industry</h4>
                    </div>
                    <p class="text-secondary">Discover jobs most relevant to you by experience level,salary,location,employment type, etc.</p>
                </div>
                <div class="col-md-6">   
                    <div class="industries d-flex border-bottom my-1">
                        <div class="bg-white me-4 circle borderColor1 shadow p-3 mb-2 d-flex justify-content-center align-items-center">
                            <img src="images/industries/o9SXyF4kPWv_4nhtaCnNLIHZvbkpWNN_R4gvPr13CNeZ-0lU0PgZXO9yhvuyC5lWKpFcn9yIfHo=.png" alt="it/computer">
                        </div> 
                        <div>
                    ...
                    <div class="industries d-flex border-bottom my-1">
                        ...
                        <div>
                            <a href="" class="text-decoration-none text-black"><h5>Education/Training</h5></a>
                            <small class="text-secondary">1200+ jobs</small>
                        </div>
                    </div>
                    <div class="industries d-flex border-bottom my-1">
                        ...
                        <div>
                            <a href="" class="text-decoration-none text-black"><h5>IT/Computer</h5></a>
                            <small class="text-secondary">1200+ jobs</small>
                        </div>
                    </div>
                    <div class="industries d-flex border-bottom my-1">
                        ...
                        <div>
                            <a href="" class="text-decoration-none text-black"><h5>Food and Beverage</h5></a>
                            <small class="text-secondary">1200+ jobs</small>
                        </div>
                    </div>                    
                </div>
    ...
    <section class="">
        <div class="container py-4">
            <h3 class="text-center"><span class="titleFirstPart">Featured</span> <span class="titleSecondPart">Locations</span></h3>
            <div class="row g-4 py-2">
                <div class="col-lg-3 col-md-4 col-6 col-xs-12">
                    <a href="" class="text-decoration-none">
