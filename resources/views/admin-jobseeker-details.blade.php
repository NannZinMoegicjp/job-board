...
<section>
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-md-3 offset-md-1 p-2 bg-light  d-flex flex-column justify-content-center align-items-center">
            <img src="{{URL::asset('images/jobseekers/'.$jobseeker->image)}}" alt="" class="profileImg">
                <h5>{{$jobseeker->name}}</h5>
                <a href="{{url('/admin/job-seekers/update/'.$jobseeker->id)}}"><button type="button" class="btn btn-primary"><i
                                class="bi bi-pencil-fill update"></i>Edit</button></a>
            </div>
