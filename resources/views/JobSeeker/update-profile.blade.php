...
<div class="container-fluid">
    ...
    <div class="row my-3">
        <div class="col-md-7 col-12 mb-1">
            ...
            @endif
            <form action="{{url('/job-seeker/update/profile')}}" class="bg-white px-3 pb-2 rounded shadow" method="post"
        ...
        <div class="col-md-5 col-12">
            <div class="row mb-3 d-flex justify-content-center shadow p-2">
                ...
                <div class="col-8">
                    <form action="{{url('/job-seeker/update/image')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="file" class="form-control mb-2" name="newProfileImage" id="newProfileImage"
                            value="{{old('logofile')}}" required>
